...
list_of_files = glob.glob("C:\\Users\\pedro\\Downloads\\*") # * means all if need specific format then *.csv
...
DataFrame.to_csv(report_cpf, r"C:\Users\pedro\Downloads\Escalamento.csv", index=False, mode='w')
